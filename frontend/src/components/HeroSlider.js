...
const DEFAULT_SLIDES = [
  {
    ...
    badge: { text: '✦ Organic Kala Cotton', type: 'new' },
    headline: 'Timeless Indian Kala & Handlooms',
    subtitle: 'Authentic handcrafted sarees, kurtas, and weaves direct from master artisans.',
  ...
  },
  {
    ...
    badge: { text: '★ Pure Banarasi & Silk', type: 'sale' },
    headline: 'Royal Handcrafted Sarees',
    subtitle: 'Heritage weaves celebrating India’s centuries of royal textile art.',
    buttonText: 'Shop Sarees',
    buttonLink: '/products?category=Sarees',
    align: 'center',
  },
  {
    id: 3,
    image: 'https://images.unsplash.com/photo-1605296867304-46d5465a13f1?w=1600&auto=format&fit=crop',
    badge: { text: '✦ Lucknowi Chikankari', type: 'new' },
    headline: 'Artisanal Kurtas & Festive Wear',
    subtitle: 'Fine needlecraft, pure khadi cotton, and regal Nehru jackets.',
    buttonText: 'Shop Kurtas',
    buttonLink: '/products?category=Kurtas',
    align: 'left',
  },
  {
    id: 4,
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1600&auto=format&fit=crop',
    badge: { text: '🌿 Sustainable & Carbon-Neutral', type: 'new' },
    headline: 'Empowering Indian Artisans',
    subtitle: 'Every handcrafted purchase directly supports traditional weaver communities.',
    buttonText: 'Support Artisans',
    buttonLink: '/products?category=Handloom',
    align: 'center',
  },
];
