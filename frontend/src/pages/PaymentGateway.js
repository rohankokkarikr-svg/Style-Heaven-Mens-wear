          ...
          {!submitted ? (
            ...
            <div className="py-6 text-center space-y-5 animate-in fade-in zoom-in duration-300">
              ...
              <p className="text-xs text-gray-400 leading-relaxed px-2">
                Thank you! Your payment reference number has been sent to Admin for verification. Once the Admin verifies your payment, your order will be placed & processed.
              </p>
